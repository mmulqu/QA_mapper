...
- Proof/content: Synthetic vector exports for address points, parcels, structures, road context, and the related Master Address, lookup, and address-variant records; an optional public Brookline Basic Address Points snapshot joined to the public Advanced Address List by `ADDRESS_ID`.
